...
public class EntityGaiaPro extends EntityLiving implements IBotaniaBoss, IEntityWithShield, IEntityAdditionalSpawnData {
    ...
    private static final DataParameter<Float> DAMAGE_TAKEN = EntityDataManager.createKey(EntityGaiaPro.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Integer> INVUL_TIME = EntityDataManager.createKey(EntityGaiaPro.class,
            DataSerializers.VARINT);
    private static final DataParameter<Integer> SHIELD = EntityDataManager.createKey(EntityGaiaPro.class,
            DataSerializers.VARINT);
