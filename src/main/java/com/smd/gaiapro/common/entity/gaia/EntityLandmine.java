...
//地雷
public class EntityLandmine extends Entity{

    public EntityLiving summoner;

    private static final String TAG_TYPE = "type";
    private static final DataParameter<Integer> TYPE = EntityDataManager.createKey(EntityLandmine.class, DataSerializers.VARINT);

    public EntityLandmine(World world) {
        super(world);
        setSize(0.5F, 0.5F);
    }
