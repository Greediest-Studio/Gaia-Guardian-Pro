...
//追踪弹
public class EntityMissile extends EntityThrowableCopy implements IBossProjectile{
    ...
    private static final DataParameter<Float> DAMAGE = EntityDataManager.createKey(EntityMissile.class, DataSerializers.FLOAT);
    private static final DataParameter<Float> TRUEDAMAGE = EntityDataManager.createKey(EntityMissile.class, DataSerializers.FLOAT);
